...
params:
  ...
  results_directory: "../pyscenic_results.dir/raw.dir/all-samples.dir/pyscenic_r.dir"
  plots_directory: "../plots.dir/raw.dir/all-samples.dir/pyscenic_r.dir"
  ...
  zscores_celltype: "../pyscenic_results.dir/raw.dir/all-samples.dir/aucell_zscores_cluster-annotation.csv"    # Z scores based on AUCell scores for celltypes
  zscores_condition: "../pyscenic_results.dir/raw.dir/all-samples.dir/aucell_zscores_tissue-annotation.csv"    # Z scores based on AUCell scores for condition or "None"
  ...
  binary_mtx: "../pyscenic_results.dir/raw.dir/all-samples.dir/binary_matrix.csv" # binary AUCell scores for each cell
  ...
  binary_heatmap_cell_annotations : "../data.dir/liver_cluster-annotation.csv" # csv file with cellid and annotation data per cell for binary all cells heatmap or "None"
  rss_celltype: "../pyscenic_results.dir/raw.dir/all-samples.dir/cluster-annotation_RSS.csv"    # RSS scores per regulon for celltype 
  rss_condition: "../pyscenic_results.dir/raw.dir/all-samples.dir/tissue-annotation_RSS.csv"    # RSS scores per regulon for condition or "None"
  rss_celltype_condition: "None"    # RSS scores per regulon for celltype_condition or "None"
  species: "human"    # fly, human, mouse or None
  regulon_genes: "../pyscenic_results.dir/raw.dir/all-samples.dir/regulons.csv"    # regulon files generatated from pipeline_pyscenic.py or "None"
  exp_matrix: "../pyscenic_results.dir/raw.dir/all-samples.dir/filtered-expression.csv"    # filtered-raw-expression.csv exp matrix generated in step 1 of pipeline_pyscenic.py for background for pathway analysis or "None"
...
wilcoxon_pathway_plot <- function(wilcoxon_f = params$wilcoxon_celltype_top, 
  ...
  if (annotation_type != "None") {
     ...
     if (nrow(comparecluster_df) > 0 & nrow(wilcoxon_top10) > 0) {
       ...
       print("comparecluster_df or wilcoxon_top10 variable is empty")
     }
  } else {
