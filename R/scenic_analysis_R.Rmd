...
params:
  ...
  wilcoxon_condition_reference_top: "wilcoxon_condition_reference_top10.csv"   # or "None", results from comparison to reference condition
...
# annotation_type is the column names from wilcoxon or KS results file with celltype or condition annotation
if (params$condition != "None") {
  wilcoxon_pathway_plot(wilcoxon_f = params$wilcoxon_condition_reference_top,
...
### Top 10 wilcoxon regulons by condition (pairwise)

```{r, fig.height = 4, fig.width = 6}
# annotation_type is the column names from wilcoxon or KS results file with celltype or condition annotation
if (params$condition != "None") {
  wilcoxon_pathway_plot(wilcoxon_f = params$wilcoxon_condition_pairwise_top,
