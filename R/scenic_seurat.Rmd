...
params:
    ...
    aucell_scores: "../../results/pyscenic/normalised.dir/merged-all_aucell.csv"
    aucell_zscores: "../../results/pyscenic/normalised.dir/aucell_zscores.csv"
    aucell_zscores_celltype: "../../results/pyscenic/normalised.dir/aucell_zscores_merged_all_cluster_annotation.csv"
    aucell_zscores_condition: "../../results/pyscenic/normalised.dir/aucell_zscores_merged_all_stimulation_annotation.csv"
    binary_matrix: "../../results/pyscenic/normalised.dir/binary_matrix.csv"
    results_directory: "../../results/pyscenic/pyscenic_r"
    plots_directory: "../../plots/pyscenic"
    datatype: normalised
    umap_pcs: 8    # how many PCs to use for clustering on AUCell scores
    cell_type: "SCT_snn_res.0.2"
...
DimPlot(seurat_object, reduction = "scenic_umap", 
        group.by = params$cell_type, label = TRUE, label.size = 3) + 
    NoLegend()
...
for (regulon in rownames(aucell_matrix)) {
    plot_violin_aucell(seurat_object, regulon, params$cell_type,
                       name = "aucell_score_violin_cluster")
}

if (params$condition != "None") {
    plot_violin_aucell(seurat_object, regulon, params$cell_type, params$condition,
...
if (params$condition != "None") {
    pdf(paste0(params$plots_directory, "/", datatype, "/top10_regulons_", params$condition, "_stacked_violin.pdf"), 
        width = 7, height = 10)
...
pdf(paste0(params$plots_directory, "/", datatype, "/top10_regulons_", params$cell_type, "_stacked_violin.pdf"), 
    width = 7, height = 10)
Idents(seurat_object) <- params$cell_type
...
# Plot
if (params$condition != "None") {
    pdf(paste0(params$plots_directory, "/", datatype, "/top10_regulons_per_", params$condition, "_z-score", "_stacked_violin.pdf"), 
        width = 7, height = 10)
    Idents(seurat_object) <- params$condition
    i <- 1
...
pdf(paste0(params$plots_directory, "/", datatype, "/top10_regulons_per_", params$cell_type, "_z-score", "_heatmap.pdf"), 
    width = 8, height = 10)
...
top10_regulons_per_celltype_abs <- top10_regulons_per_group_abs(
    aucell_matrix, metadata, group = params$cell_type)
```
...
if (params$condition != "None") {
    ...
    pdf(paste0(params$plots_directory, "/", datatype, "/top10_regulons_per_", params$condition, "_abs", "_heatmap.pdf"), 
        width = 8, height = 6)
...
if (params$condition != "None") {
    aucell_matrix_long <- aucell_matrix %>%
        ...
        pivot_longer(-regulon, names_to = "barcode", values_to = "aucell_score") %>%
        left_join(metadata %>% 
                      select(barcode, !!sym(params$condition), !!sym(params$cell_type)))
} else {
    aucell_matrix_long <- aucell_matrix %>%
        rownames_to_column(var = "regulon") %>%
        pivot_longer(-regulon, names_to = "barcode", values_to = "aucell_score") %>%
...
wilcoxon_results_celltype <- all_regulons_comparison(
    ...
    aucell_matrix_long, params$cell_type, "wilcoxon")
...
write_csv(wilcoxon_markers_celltype, 
          paste0(results_directory, "/", datatype, "/", "wilcoxon_celltype_comparison_FindMarkers.csv"))
...
if (params$condition != "None") {
    ...
    write_csv(wilcoxon_markers_condition_reference, 
              paste0(results_directory, "/", datatype, "/", "wilcoxon_condition_reference_comparison_FindMarkers.csv"))
}
...
if (params$condition != "None") {
    ...
    for (i in 1:length(identities)) {
        ...
        for (k in 1:length(reference_identities)) {
            ...
            markers <- rownames_to_column(markers, var = "regulon")
            wilcoxon_markers_list[[paste(test_identity, reference_identities[k], sep = "_")]] <- markers
        }
    }
    wilcoxon_markers_condition_pairwise <- bind_rows(wilcoxon_markers_list)
    write_csv(wilcoxon_markers_condition_pairwise, 
              paste0(results_directory, "/", datatype, "/", "wilcoxon_condition_pairwise_comparison_FindMarkers.csv"))
}
...
if (params$condition != "None") {
    ...
    write_csv(wilcoxon_markers_condition, 
              paste0(results_directory, "/", datatype, "/", "wilcoxon_condition_onevsall_comparison_FindMarkers.csv"))
}
```
...
write_csv(ks_results_condition[, c(1:4, 7, 5, 6)], 
          paste0(results_directory, "/", datatype, "/", "ks_condition_comparison.csv"))}, silent = TRUE)
...
write_csv(ks_results_celltype[, c(1:4, 7, 5, 6)], 
          paste0(results_directory, "/", datatype, "/", "ks_celltype_comparison.csv"))
```
...
write_csv(top10_wilcoxon_celltype, 
          paste0(results_directory, "/", datatype, "/", "wilcoxon_celltype_top10_FindMarkers.csv"))
...
write_csv(top10_ks_celltype, 
          paste0(results_directory, "/", datatype, "/", "ks_celltype_top10.csv"))
...
if (params$condition != "None") {
    ...
    write_csv(top10_wilcoxon_condition_reference,
              paste0(results_directory, "/", datatype, "/", "wilcoxon_condition_reference_top10_FindMarkers.csv"))
    ...
    write_csv(top10_wilcoxon_condition_pairwise, 
              paste0(results_directory, "/", datatype, "/", "wilcoxon_condition_pairwise_top10_FindMarkers.csv"))
    ...
    write_csv(top10_ks_condition, 
              paste0(results_directory, "/", datatype, "/", "ks_condition_top10.csv"))
}
```
...
top10_heatmap <- function(top10_regulons_table, 
    ...
    # Set anything above 3 to 3, and anything below -3 to -3
    top10_regulons_table_filtered <- apply(
        top10_regulons_table_filtered,
        MARGIN = 1,
        FUN = function(x) ifelse(x > 3, 3, x))
    top10_regulons_table_filtered <- apply(
        top10_regulons_table_filtered, 
    ...
    annotation_col <- metadata %>%
        select(barcode, contains(group)) %>%
        column_to_rownames(var = "barcode")

    pheatmap(top10_regulons_table_filtered, 
             show_colnames = FALSE,
             annotation_col = annotation_col, 
             filename = paste0(params$plots_directory, "/", datatype, "/top10_regulons_wilcoxon_", group, filename, "_heatmap.pdf"), 
             width = 8, height = 10)
...
Idents(seurat_object) <- params$cell_type
top10_wilcoxon_celltype_average <- AverageExpression(
    seurat_object, 
...
pheatmap(top10_wilcoxon_celltype_average, 
         scale = "row",
         filename = paste0(params$plots_directory, "/", datatype, "/top10_regulons_wilcoxon_", params$cell_type, "_average_heatmap.pdf"), 
         width = 5, height = 6)

if (params$condition != "None") {
    Idents(seurat_object) <- params$condition
    top10_wilcoxon_condition_reference_average <- AverageExpression(
        seurat_object, 
    ...
    pheatmap(top10_wilcoxon_condition_reference_average, 
             scale = "row",
             filename = paste0(params$plots_directory, "/", datatype, "/top10_regulons_wilcoxon_condition_reference_average_heatmap.pdf"), 
             width = 5, height = 6)
    
    top10_wilcoxon_condition_pairwise_average <- AverageExpression(
        seurat_object, 
        features = unique(top10_wilcoxon_condition_pairwise$regulon), 
        assays = "scenic", 
        slot = "scale.data")
    top10_wilcoxon_condition_pairwise_average <- top10_wilcoxon_condition_pairwise_average[["scenic"]]
    pheatmap(top10_wilcoxon_condition_pairwise_average, 
             scale = "row",
             filename = paste0(params$plots_directory, "/", datatype, "/top10_regulons_wilcoxon_condition_pairwise_average_heatmap.pdf"),
             width = 5, height = 6)
}
```
...
Idents(seurat_object) <- params$cell_type
top10_ks_celltype_average <- AverageExpression(
    seurat_object, 
    features = unique(top10_ks_celltype$regulon), 
    assays = "scenic", 
    slot = "scale.data")
top10_ks_celltype_average <- top10_ks_celltype_average[["scenic"]]
pheatmap(top10_ks_celltype_average, 
         scale = "row",
         filename = paste0(params$plots_directory, "/", datatype, "/top10_regulons_ks_", params$cell_type, "_average_heatmap.pdf"), 
         width = 5, height = 8, fontsize = 6)

if (params$condition != "None") {
    Idents(seurat_object) <- params$condition
    top10_ks_condition_average <- AverageExpression(
        seurat_object, 
        features = unique(top10_ks_condition$regulon), 
        assays = "scenic", 
        slot = "scale.data")
    top10_ks_condition_average <- top10_ks_condition_average[["scenic"]]
    pheatmap(top10_ks_condition_average, 
             scale = "row",
             filename = paste0(params$plots_directory, "/", datatype, "/top10_regulons_ks_", params$condition, "_average_heatmap.pdf"), 
             width = 5, height = 6)
}
```
