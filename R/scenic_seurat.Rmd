...
params:
    workingdir: "pyscenic_results.dir"
    seurat_object: "../../results/Robjects/merged_all_analysed.rds"
    aucell_scores: "../../results/pyscenic/normalised/merged-all_aucell.csv"
    aucell_zscores: "../../results/pyscenic/normalised/aucell_zscores.csv"
    aucell_zscores_celltype: "../../results/pyscenic/normalised/aucell_zscores_merged_all_cluster_annotation.csv"
    aucell_zscores_condition: "../../results/pyscenic/normalised/aucell_zscores_merged_all_stimulation_annotation.csv"
...
#### AUCell scores on gene expression UMAP
...
seurat_object <- FindClusters(seurat_object, graph.name = "scenic_snn", res = params$clustering_resolution)
DimPlot(seurat_object, reduction = "scenic_umap", group.by = params$cell_type)
```
...
if (params$condition != "None") {
    Idents(seurat_object) <- params$condition
    top10_ks_condition_ref_average <- AverageExpression(seurat_object, features = unique( top10_ks_condition$regulon), assays = "scenic", slot = "scale.data")
    top10_ks_condition_reference <- top10_ks_condition_reference[["scenic"]]
    pheatmap(top10_ks_condition_ref_average, scale = "row", 
