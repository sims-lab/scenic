...
DimPlot(seurat_object, reduction = "scenic_umap", 
        group.by = params$cell_type, label = TRUE, label.size = 4) + 
    NoLegend() +
...
DimPlot(seurat_object, reduction = "umap", 
        group.by = paste0("scenic_snn_res.", params$clustering_resolution), label = TRUE, label.size = 4) + 
    NoLegend() +
    ggtitle("SCENIC clusters") +
    theme(plot.title = element_text(hjust = 0.5))
...
if (params$condition != "None") {
    pdf(paste0(params$plots_directory, "/", datatype, "/top10_regulons_", 
...
pdf(paste0(params$plots_directory, "/", datatype, "/top10_regulons_", 
           params$cell_type, "_stacked_violin.pdf"), 
    width = 7, height = 10)
Idents(seurat_object) <- params$cell_type
...
# Plot
if (params$condition != "None") {
    pdf(paste0(params$plots_directory, "/", datatype, "/top10_regulons_per_",
...
pdf(paste0(params$plots_directory, "/", datatype, "/top10_regulons_per_", 
           params$cell_type, "_z-score", "_stacked_violin.pdf"), 
    width = 7, height = 10)
Idents(seurat_object) <- params$cell_type
i <- 1
...
pdf(paste0(params$plots_directory, "/", datatype, "/top10_regulons_per_",
           params$cell_type, "_z-score", "_heatmap.pdf"), 
    width = 8, height = 10)
...
if (params$condition != "None") {
    ...
    pdf(paste0(params$plots_directory, "/", datatype, "/top10_regulons_per_",
               params$condition, "_abs", "_heatmap.pdf"), 
        width = 8, height = 6)
...
pdf(paste0(params$plots_directory, "/", datatype, "/top10_regulons_per_", 
           params$cell_type, "_abs", "_heatmap.pdf"), 
    width = 8, height = 10)
...
write_csv(wilcoxon_markers_celltype, 
          paste0(results_directory, "/", datatype, "/",
                 "wilcoxon_celltype_comparison_FindMarkers.csv"))
...
if (params$condition != "None") {
    ...
    write_csv(wilcoxon_markers_condition, 
              paste0(results_directory, "/", datatype, "/",
                     "wilcoxon_condition_onevsall_comparison_FindMarkers.csv"))
}
...
if (params$condition != "None") {
    ...
    write_csv(wilcoxon_markers_condition_reference, 
              paste0(results_directory, "/", datatype, "/",
                     "wilcoxon_condition_reference_comparison_FindMarkers.csv"))
}
...
if (params$condition != "None") {
    ...
    write_csv(wilcoxon_markers_condition_pairwise, 
              paste0(results_directory, "/", datatype, "/",
                     "wilcoxon_condition_pairwise_comparison_FindMarkers.csv"))
}
```
...
write_csv(ks_results_condition[, c(1:4, 7, 5, 6)], 
          paste0(results_directory, "/", datatype, "/", "ks_condition_comparison.csv"))}, 
silent = TRUE)
...
write_csv(top10_wilcoxon_celltype, 
          paste0(results_directory, "/", datatype, "/", "wilcoxon_celltype_top10.csv"))
...
top10_heatmap <- function(top10_regulons_table, 
    ...
    pheatmap(top10_regulons_table_filtered, 
             show_colnames = FALSE,
             annotation_col = annotation_col, 
             filename = paste0(params$plots_directory, "/", datatype, "/top10_regulons_wilcoxon_",
...
pheatmap(top10_wilcoxon_celltype_average, 
         scale = "row",
         filename = paste0(params$plots_directory, "/", datatype, "/top10_regulons_wilcoxon_",
                           params$cell_type, "_average_heatmap.pdf"), 
         width = 5, height = 6)
...
if (params$condition != "None") {
    ...
    pheatmap(top10_wilcoxon_condition_reference_average, 
             scale = "row",
             filename = paste0(params$plots_directory, "/", datatype,
...
pheatmap(top10_ks_celltype_average, 
         scale = "row",
         filename = paste0(params$plots_directory, "/", datatype, "/top10_regulons_ks_",
                           params$cell_type, "_average_heatmap.pdf"), 
