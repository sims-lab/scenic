...
pdf(paste0(plots_directory, "/top10_regulons_per_",
           params$celltype, "_abs", "_heatmap.pdf"),
    width = 8, height = 10)
...
if (params$condition != "None") {
    ...
    pheatmap(top10_wilcoxon_condition_reference_average,
             scale = "row",
             filename = paste0(plots_directory, "/top10_regulons_wilcoxon_condition_reference_average_heatmap.pdf"),
             width = 5, height = 6)
    ...
    pheatmap(top10_wilcoxon_condition_pairwise_average,
             scale = "row",
             filename = paste0(plots_directory, "/top10_regulons_wilcoxon_condition_pairwise_average_heatmap.pdf"),
             width = 5, height = 6)
}
```
