...
latent_variables <- ifelse(params$latent_variables != "None",
                           params$latent_variables, NULL)
...
if (params$condition != "None" & params$celltype_condition != "None") {
  ...
  for (iden in as.character(unique(Idents(seurat_object)))) {
    ...
    markers_condition_reference <- bind_rows(markers_list)
    celltype_list[[iden]] <- markers_condition_reference
  }
...
if (params$condition != "None" & params$celltype_condition != "None") {
  ...
  for (iden in as.character(unique(Idents(seurat_object)))) {
    ...
    celltype_list[[iden]] <- markers_condition_pairwise
  }
