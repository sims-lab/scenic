...
if(params$condition != "None" & params$celltype_condition != "None"){
  ...
  write_csv(wilcoxon_markers_cellsubtype_condition_pairwise,
            file = paste0(results_directory, 
                          "/wilcoxon_celltype_condition_pairwise_comparison.csv"))
...
if (nrow(top10_wilcoxon_celltype) > 0) {
  ...
  p <- DotPlot(object = seurat_object,assay = "scenic", 
               features = unique(top10_wilcoxon_celltype$regulon),
...
if (params$condition != "None") {
  ...
  if (nrow(top10_wilcoxon_condition) > 0) {
    ...
    cluster.idents <- ifelse(nrow(top10_wilcoxon_condition) > 2,
                             TRUE, FALSE)
    p <- DotPlot(object = seurat_object, assay = "scenic", 
                 features = unique(top10_wilcoxon_condition$regulon),
                 cols = "RdYlBu", col.max = 3, col.min = -3, 
                 cluster.idents = cluster.idents) + 
      RotatedAxis() + 
      FontSize(x.text = 9, y.text = 10, x.title = 8, y.title = 8)
    p <- p + 
      theme(legend.text = element_text(size = 12), 
            legend.title = element_text(size = 12))
    ggsave(filename = paste0(plots_directory,
                             "/top10_regulons_wilcoxon_condition_dotplot.pdf"),
           width = 8, height = 6)
  ...
  if (nrow(top10_wilcoxon_condition_reference) > 0) {
    ...
    cluster.idents <- ifelse(nrow(top10_wilcoxon_condition_reference) > 2,
                             TRUE, FALSE)
    p <- DotPlot(object = seurat_object,assay = "scenic", 
                 features = unique(top10_wilcoxon_condition_reference$regulon),
                 cols = "RdYlBu", col.max = 3, col.min = -3, 
                 cluster.idents = cluster.idents) + 
      RotatedAxis() + 
      FontSize(x.text = 9, y.text = 10, x.title = 8, y.title = 8)
    p <- p + 
      theme(legend.text = element_text(size = 12), 
            legend.title = element_text(size = 12))
    ggsave(filename = paste0(plots_directory,
                             "/top10_regulons_wilcoxon_condition_reference_dotplot.pdf"), 
           width = 8, height = 6)
  ...
  if (nrow(top10_wilcoxon_condition_pairwise) > 0) {
    ...
    cluster.idents <- ifelse(nrow(top10_wilcoxon_condition_pairwise) > 2,
                             TRUE, FALSE)
    p <- DotPlot(object = seurat_object,assay = "scenic", 
                 features = unique(top10_wilcoxon_condition_pairwise$regulon),
                 cols = "RdYlBu", col.max = 3, col.min = -3, 
                 cluster.idents = cluster.idents) +
      RotatedAxis() + 
      FontSize(x.text = 9, y.text = 10, x.title = 8, y.title = 8)
    p <- p + 
      theme(legend.text = element_text(size = 12), 
            legend.title = element_text(size = 12))
    ggsave(filename = paste0(plots_directory,
                             "/top10_regulons_wilcoxon_condition_pairwise_dotplot.pdf"),
           width = 8, height = 6)
...
if (params$condition != "None" & params$celltype_condition != "None") {
  ...
  if (nrow(top10_wilcoxon_cellsubtype_condition_reference) > 0) {
    ...
    cluster.idents <- ifelse(nrow(top10_wilcoxon_cellsubtype_condition_reference) > 2,
                             TRUE, FALSE)
    p <- DotPlot(object = seurat_object,assay = "scenic", 
                 features = unique(top10_wilcoxon_cellsubtype_condition_reference$regulon),
                 cols = "RdYlBu", col.max = 3, col.min = -3, 
                 cluster.idents = cluster.idents) + 
      RotatedAxis() + 
      FontSize(x.text = 9,y.text = 10, x.title = 8, y.title = 8)
    p <- p + 
      theme(legend.text = element_text(size = 12), 
            legend.title = element_text(size = 12))
    ggsave(filename = paste0(plots_directory,
                             "/top10_regulons_wilcoxon_celltype_condition_reference_dotplot.pdf"),
           width = 8, height = 6)
  ...
  if (nrow(top10_wilcoxon_cellsubtype_condition_pairwise) > 0) {
    ...
    cluster.idents <- ifelse(nrow(top10_wilcoxon_cellsubtype_condition_pairwise) > 2,
                             TRUE, FALSE)
    p <- DotPlot(object = seurat_object,assay = "scenic", 
                 features = unique(top10_wilcoxon_cellsubtype_condition_pairwise$regulon),
                 cols = "RdYlBu", col.max = 3, col.min = -3, 
                 cluster.idents = cluster.idents) + 
      RotatedAxis() + 
      FontSize(x.text = 9, y.text = 10, x.title = 8, y.title = 8)
    p <- p + 
      theme(legend.text = element_text(size = 12), 
            legend.title = element_text(size = 12))
    ggsave(filename = paste0(plots_directory,
                             "/top10_regulons_wilcoxon_celltype_condition_pairwise_dotplot.pdf"),
           width = 8, height = 6)
